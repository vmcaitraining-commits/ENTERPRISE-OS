    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-2 bg-slate-100 dark:bg-slate-900/80 rounded-2xl border border-slate-200 dark:border-slate-800">
        <div className="flex flex-wrap gap-1.5">
          ...
          >
            4. Liên thông Hợp đồng → Kế toán → CSKH
          </button>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-100 dark:border-slate-800">
            <div>
              <h4 className="text-sm font-bold text-[#0B1F3A] dark:text-white flex items-center gap-2">
                ...
                Đường ống cơ hội bán hàng (Sales Opportunity Pipeline)
              </h4>
            ...
            <div className="flex items-center gap-3 text-xs text-slate-500">
              <span>Tổng giá trị đường ống: <strong className="text-emerald-600 dark:text-emerald-400 font-mono">1.480.000.000 đ</strong></span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            ...
            <div className="bg-slate-50/80 dark:bg-slate-900/60 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider">Tiếp cận & Đánh giá</span>
              ...
              <div className="space-y-2.5">
                <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-slate-200/70 dark:border-slate-700/60 shadow-2xs space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-500 line-clamp-1">Nhu cầu: Hợp nhất CRM & Kho dược</p>
                  <div className="flex items-center justify-between text-[11px] pt-1 text-slate-400">
                    <span>Trị giá: <strong className="text-slate-700 dark:text-slate-200">120M</strong></span>
                    <span>Xác suất: 40%</span>
                  </div>
                </div>
                ...
                <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-slate-200/70 dark:border-slate-700/60 shadow-2xs space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-500 line-clamp-1">Nhu cầu: Báo giá tự động cho 6 showroom</p>
                  <div className="flex items-center justify-between text-[11px] pt-1 text-slate-400">
                    <span>Trị giá: <strong className="text-slate-700 dark:text-slate-200">85M</strong></span>
                    <span>Xác suất: 45%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50/50 dark:bg-blue-950/20 p-3.5 rounded-xl border border-blue-200/60 dark:border-blue-900/40 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-blue-800 dark:text-blue-300 uppercase tracking-wider">Tư vấn & Báo giá</span>
              ...
              <div className="space-y-2.5">
                <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-blue-200/60 dark:border-slate-700/60 shadow-2xs space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-500 line-clamp-1">Báo giá: Triển khai 45 user phân hệ CRM</p>
                  <div className="flex items-center justify-between text-[11px] pt-1 text-slate-400">
                    <span>Trị giá: <strong className="text-slate-700 dark:text-slate-200">240M</strong></span>
                    <span>Xác suất: 65%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50/50 dark:bg-amber-950/20 p-3.5 rounded-xl border border-amber-200/60 dark:border-amber-900/40 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-300 uppercase tracking-wider">Đàm phán điều khoản</span>
              ...
              <div className="space-y-2.5">
                <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-amber-200/60 dark:border-slate-700/60 shadow-2xs space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-500 line-clamp-1">Thương lượng: Điều khoản thanh toán 3 đợt</p>
                  <div className="flex items-center justify-between text-[11px] pt-1 text-slate-400">
                    <span>Trị giá: <strong className="text-slate-700 dark:text-slate-200">180M</strong></span>
                    <span>Xác suất: 85%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-emerald-50/50 dark:bg-emerald-950/20 p-3.5 rounded-xl border border-emerald-200/60 dark:border-emerald-900/40 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-emerald-800 dark:text-emerald-300 uppercase tracking-wider">Won / Đã ký kết</span>
              ...
              <div className="space-y-2.5">
                <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-emerald-200/60 dark:border-slate-700/60 shadow-2xs space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-[10px] font-mono text-emerald-700 bg-emerald-100 dark:bg-emerald-950/80 px-1.5 py-0.5 rounded">Đã ký OTP</span>
                  </div>
                  <p className="text-[11px] text-slate-500 line-clamp-1">Tự động bàn giao sang Kế toán & CSKH</p>
                  <div className="flex items-center justify-between text-[11px] pt-1 text-slate-400">
                    <span>Doanh số: <strong className="text-emerald-600 dark:text-emerald-400">160M</strong></span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-100 dark:border-slate-800">
            <div>
              <h4 className="text-sm font-bold text-[#0B1F3A] dark:text-white flex items-center gap-2">
                ...
                Hồ sơ khách hàng 360 độ (Customer 360 View)
              </h4>
              <p className="text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[11px] text-slate-500">Ngành: Bán buôn thiết bị điện máy</span>
                </div>
              </div>
              ...
              <div className="space-y-1.5 text-xs text-slate-600 dark:text-slate-300 pt-2 border-t border-slate-200 dark:border-slate-800">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-blue-600">Google Ads chiến dịch B2B</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-400">Chuyên viên quản lý:</span>
              ...
              <div className="space-y-2 text-xs">
                <div className="p-2.5 bg-white dark:bg-[#0B1528] rounded-lg border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-[10px] text-slate-400">Gói AI Enterprise 3 phân hệ</div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px]">
                  <div className="p-2 bg-emerald-50 dark:bg-emerald-950/40 rounded-lg border border-emerald-200 dark:border-emerald-900 text-emerald-800 dark:text-emerald-200">
                    <span className="block text-[10px] text-emerald-600">Đã thu đợt 1:</span>
                  ...
                  <div className="p-2 bg-blue-50 dark:bg-blue-950/40 rounded-lg border border-blue-200 dark:border-blue-900 text-blue-800 dark:text-blue-200">
                    <span className="block text-[10px] text-blue-600">Còn phải thu:</span>
                    <strong className="font-mono text-xs">60.000.000 đ</strong>
                  </div>
                </div>
              </div>
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-900/60 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2.5">
              <span className="text-xs font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
                ...
                Dòng thời gian tương tác (Timeline)
              </span>
              <div className="space-y-2 text-xs">
                <div className="flex items-start gap-2">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 mt-1 shrink-0"></span>
                  <div>
                    <span className="text-[11px] font-bold text-slate-800 dark:text-slate-200">Đã ký kết hợp đồng điện tử qua OTP</span>
                    <p className="text-[10px] text-slate-400">10:45 Hôm nay · Tự động gửi email xác nhận</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <span className="w-2 h-2 rounded-full bg-blue-500 mt-1 shrink-0"></span>
                  <div>
                    <span className="text-[11px] font-bold text-slate-800 dark:text-slate-200">Cuộc gọi tư vấn giải pháp 28 phút</span>
                    <p className="text-[10px] text-slate-400">14:20 Hôm qua · AI Voice đã bóc băng & tóm tắt</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <span className="w-2 h-2 rounded-full bg-slate-400 mt-1 shrink-0"></span>
                  <div>
                    <span className="text-[11px] font-bold text-slate-800 dark:text-slate-200">Gửi biểu mẫu tư vấn từ Website</span>
                    <p className="text-[10px] text-slate-400">09:12 Hai ngày trước · Điểm số tiềm năng 92/100</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-100 dark:border-slate-800">
            <div>
              <h4 className="text-sm font-bold text-[#0B1F3A] dark:text-white flex items-center gap-2">
                ...
                Phễu chuyển đổi bán hàng (Conversion Funnel)
              </h4>
              <p className="text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="space-y-3 max-w-2xl mx-auto">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-200">
                <span>1. Lượng tiếp cận & Traffic web</span>
                <span className="font-mono">12.400 lượt</span>
              </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-200">
                <span>2. Lead để lại thông tin tư vấn</span>
                <span className="font-mono">840 lead (6.7%)</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-8 rounded-xl overflow-hidden p-1 flex items-center">
                <div className="bg-blue-500 h-full rounded-lg text-white text-[11px] font-bold flex items-center px-3 justify-between" style={{ width: '75%' }}>
                  <span>Tự động phân bổ vào CRM</span>
                  <span>75%</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-200">
                <span>3. Cơ hội liên hệ & Đạt chuẩn tư vấn</span>
                <span className="font-mono">210 cơ hội</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-8 rounded-xl overflow-hidden p-1 flex items-center">
                <div className="bg-indigo-500 h-full rounded-lg text-white text-[11px] font-bold flex items-center px-3 justify-between" style={{ width: '52%' }}>
                  <span>Tư vấn giải pháp 1-1</span>
                  <span>52%</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-slate-200">
                <span>4. Gửi báo giá & Hợp đồng dự thảo</span>
                <span className="font-mono">95 báo giá</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-8 rounded-xl overflow-hidden p-1 flex items-center">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs font-bold text-emerald-700 dark:text-emerald-400">
                <span>5. Hợp đồng chính thức ký kết & Đóng deal</span>
                <span className="font-mono">38 hợp đồng</span>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 h-8 rounded-xl overflow-hidden p-1 flex items-center">
                <div className="bg-emerald-600 h-full rounded-lg text-white text-[11px] font-bold flex items-center px-3 justify-between" style={{ width: '22%' }}>
                  <span>Won - Doanh số thực</span>
                  <span>22% từ báo giá</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="p-5 sm:p-6 bg-white dark:bg-[#0D182E] rounded-2xl border border-slate-200 dark:border-slate-800 space-y-5 shadow-2xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative">
            ...
            <div className="p-4 bg-blue-50/60 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-900/60 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-blue-900 dark:text-blue-200 uppercase tracking-wider">Khởi nguồn: Sales</span>
              ...
              <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-blue-100 dark:border-blue-950 space-y-1.5 text-xs">
                <div className="font-bold text-[#0B1F3A] dark:text-white">Ký Hợp đồng điện tử</div>
                <p className="text-slate-500 text-[11px]">Khách hàng xác nhận mã OTP ký số. Trạng thái cơ hội chuyển thành WON.</p>
                <div className="pt-2 text-[10px] font-mono text-blue-600">→ Bắn tín hiệu Event Bus: contract.signed</div>
              </div>
            </div>
            ...
            <div className="p-4 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-xl border border-emerald-200 dark:border-emerald-900/60 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-emerald-900 dark:text-emerald-200 uppercase tracking-wider">Tiếp nhận: Kế toán</span>
              ...
              <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-emerald-100 dark:border-emerald-950 space-y-1.5 text-xs">
                <div className="font-bold text-[#0B1F3A] dark:text-white">Tự sinh Phiếu thu & Hóa đơn</div>
                <p className="text-slate-500 text-[11px]">Hệ thống tạo phiếu thu đợt 1 (50%), mở công nợ đợt 2 theo hạn 30 ngày, xuất hóa đơn điện tử.</p>
                <div className="pt-2 text-[10px] font-mono text-emerald-600">→ Bắn tín hiệu: invoice.issued</div>
              </div>
            </div>
            ...
            <div className="p-4 bg-cyan-50/60 dark:bg-cyan-950/30 rounded-xl border border-cyan-200 dark:border-cyan-900/60 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-cyan-900 dark:text-cyan-200 uppercase tracking-wider">Hậu mãi: CSKH & Triển khai</span>
              ...
              <div className="p-3 bg-white dark:bg-[#0B1528] rounded-lg border border-cyan-100 dark:border-cyan-950 space-y-1.5 text-xs">
                <div className="font-bold text-[#0B1F3A] dark:text-white">Mở Ticket Onboarding tự động</div>
                <p className="text-slate-500 text-[11px]">Kế thừa toàn bộ hồ sơ Customer 360, gửi email chào mừng và kích hoạt lịch hướng dẫn sử dụng.</p>
                <div className="pt-2 text-[10px] font-mono text-cyan-600">→ SLA phản hồi đầu tiên: ≤ 15 phút</div>
              </div>
            </div>
          </div>
        </div>
